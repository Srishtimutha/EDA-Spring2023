...
> Answer: I am using using R and Git for the first time, I hav not done data analytics before.

2. Are there any components of the course about which you feel confident?

> Answer:Not currently, but I believe with time I'll be more confident about using the R software.

3. Are there any components of the course about which you feel apprehensive?

> Answer: coding and data visualization
...
> Answer: https://github.com/Srishtimutha/EDA-Spring2023.git
